external_url "https://gitlab.local.com:443"
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.local.com/certificate.pem"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/gitlab.local.com/certificate.key"
